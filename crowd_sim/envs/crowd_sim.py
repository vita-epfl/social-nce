...
class CrowdSim(gym.Env):
    ...
    def set_counter(self, counter):
        self.case_counter['train'] = counter
        logging.info('Set train counter to {:d}'.format(self.case_counter['train']))
        ...
        if mode == 'human':
            ...
            for k in range(len(self.states)):
                ...
                if k == len(self.states) - 1:
                    time = plt.text(robot.center[0] - x_offset, robot.center[1] - y_offset,
                                      '{:.1f}'.format(global_time),
